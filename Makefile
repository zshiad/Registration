...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Nov 30 19:50:37 2016
# Project:  main.pro
# Template: app
# Command: /usr/local/software/qt4/bin/qmake -o Makefile main.pro
#############################################################################
...
INCPATH       = -I/usr/local/software/qt-4.8.6/mkspecs/linux-g++-64 -I. -I/usr/local/software/qt-4.8.6/include/QtCore -I/usr/local/software/qt-4.8.6/include/QtGui -I/usr/local/software/qt-4.8.6/include -I.
LINK          = g++
...
Makefile: main.pro  /usr/local/software/qt-4.8.6/mkspecs/linux-g++-64/qmake.conf /usr/local/software/qt-4.8.6/mkspecs/common/unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/linux.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base-unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/main1.0.0/ && $(COPY_FILE) --parents DoublyLinkedList.h Records.h utility.h HashTable.h RegistrationManager.h html.h ReportGeneration.h FileManagement.h .tmp/main1.0.0/ && $(COPY_FILE) --parents main.cpp Records.cpp RegistrationManager.cpp html.cpp ReportGeneration.cpp FileManagement.cpp .tmp/main1.0.0/ && (cd `dirname .tmp/main1.0.0` && $(TAR) main1.0.0.tar main1.0.0 && $(COMPRESS) main1.0.0.tar) && $(MOVE) `dirname .tmp/main1.0.0`/main1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/main1.0.0
...
Records.o: Records.cpp Records.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Records.o Records.cpp

RegistrationManager.o: RegistrationManager.cpp RegistrationManager.h \
		Records.h \
		DoublyLinkedList.h \
		HashTable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o RegistrationManager.o RegistrationManager.cpp

html.o: html.cpp html.h \
		DoublyLinkedList.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o html.o html.cpp

ReportGeneration.o: ReportGeneration.cpp RegistrationManager.h \
		Records.h \
		DoublyLinkedList.h \
		HashTable.h \
		ReportGeneration.h \
		html.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ReportGeneration.o ReportGeneration.cpp

FileManagement.o: FileManagement.cpp FileManagement.h \
		RegistrationManager.h \
		Records.h \
		DoublyLinkedList.h \
		HashTable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FileManagement.o FileManagement.cpp
